...
final class TListSaleItemPos999Service {
    ...
    {        
        ...
        $repository = new TRepository('poscontrol','_list_sale_items_pos');
    ...
    {        
        ...
        $criteria->add(new TFilter('DatetimeSale', '>=', $DatetimeBegin));
        $criteria->add(new TFilter('DatetimeSale', '<=', $DatetimeEnd));
        $criteria->setProperty('group', '_list_sale_items_pos.ProductID, ProductName, ImageBase64');
        $criteria->setProperty('order', 'sum(AmntTotal) desc');


        $fields = array(
          "_list_sale_items_pos.ProductID",
          "ProductName",
          "ImageBase64",
