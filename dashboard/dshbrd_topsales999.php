...
use ado\service\TListSaleItemPos999Service;
...
function dashboardtopsale($token, $activeCompany, $dashboardType, $topsaleType)
{
  ...
  $listsaleitempos999service = new TListSaleItemPos999Service;
  if (isset($dashboardType) AND $dashboardType !== ":1") {
    ...
    $rtrTotalSaleHD = $listsaleitempos999service->getListSaleItemPosTotalSaleHD($Companies, $activeCompany, $DatetimeBegin, $DatetimeEnd);
    $rtrTopSale     = $listsaleitempos999service->getListSaleItemTopSale($Companies, $activeCompany, $DatetimeBegin, $DatetimeEnd);
    $rtrTopSaleHD   = $listsaleitempos999service->getListSaleItemTopSaleHD($Companies, $activeCompany, $DatetimeBegin, $DatetimeEnd);

  } else {
    switch ($topsaleType) {
      case 1:
        $rtrTotalSaleHD = $listsaleitempos999service->getListSaleItemPosTotalSaleHD1($Companies, $activeCompany);
        $rtrTopSale     = $listsaleitempos999service->getListSaleItemTopSale1($Companies, $activeCompany);
        $rtrTopSaleHD   = $listsaleitempos999service->getListSaleItemTopSaleHD1($Companies, $activeCompany);
        break;
      case 2:
        $rtrTotalSaleHD = $listsaleitempos999service->getListSaleItemPosTotalSaleHD2($Companies, $activeCompany);
        $rtrTopSale     = $listsaleitempos999service->getListSaleItemTopSale2($Companies, $activeCompany);
        $rtrTopSaleHD   = $listsaleitempos999service->getListSaleItemTopSaleHD2($Companies, $activeCompany);
        break;
      case 3:
        $rtrTotalSaleHD = $listsaleitempos999service->getListSaleItemPosTotalSaleHD3($Companies, $activeCompany);
        $rtrTopSale     = $listsaleitempos999service->getListSaleItemTopSale3($Companies, $activeCompany);
        $rtrTopSaleHD   = $listsaleitempos999service->getListSaleItemTopSaleHD3($Companies, $activeCompany);
        break;      
      default:
        $rtrTotalSaleHD = $listsaleitempos999service->getListSaleItemPosTotalSaleHD4($Companies, $activeCompany);
        $rtrTopSale     = $listsaleitempos999service->getListSaleItemTopSale4($Companies, $activeCompany);
        $rtrTopSaleHD   = $listsaleitempos999service->getListSaleItemTopSaleHD4($Companies, $activeCompany);
        break;
    }
  }
