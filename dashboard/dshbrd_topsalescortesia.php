...
use ado\service\TListSaleItemPosCortesiaService;
...
function dashboardtopsale($token, $activeCompany, $dashboardType, $topsaleType)
{
  ...
  $listsaleitemposcortesiaservice = new TListSaleItemPosCortesiaService;
  if (isset($dashboardType) AND $dashboardType !== ":1") {
    ...
    $rtrTotalSaleHD = $listsaleitemposcortesiaservice->getListSaleItemPosTotalSaleHD($Companies, $activeCompany, $DatetimeBegin, $DatetimeEnd);
    $rtrTopSale     = $listsaleitemposcortesiaservice->getListSaleItemTopSale($Companies, $activeCompany, $DatetimeBegin, $DatetimeEnd);
    $rtrTopSaleHD   = $listsaleitemposcortesiaservice->getListSaleItemTopSaleHD($Companies, $activeCompany, $DatetimeBegin, $DatetimeEnd);

  } else {
    switch ($topsaleType) {
      case 1:
        $rtrTotalSaleHD = $listsaleitemposcortesiaservice->getListSaleItemPosTotalSaleHD1($Companies, $activeCompany);
        $rtrTopSale     = $listsaleitemposcortesiaservice->getListSaleItemTopSale1($Companies, $activeCompany);
        $rtrTopSaleHD   = $listsaleitemposcortesiaservice->getListSaleItemTopSaleHD1($Companies, $activeCompany);
        break;
      case 2:
        $rtrTotalSaleHD = $listsaleitemposcortesiaservice->getListSaleItemPosTotalSaleHD2($Companies, $activeCompany);
        $rtrTopSale     = $listsaleitemposcortesiaservice->getListSaleItemTopSale2($Companies, $activeCompany);
        $rtrTopSaleHD   = $listsaleitemposcortesiaservice->getListSaleItemTopSaleHD2($Companies, $activeCompany);
        break;
      case 3:
        $rtrTotalSaleHD = $listsaleitemposcortesiaservice->getListSaleItemPosTotalSaleHD3($Companies, $activeCompany);
        $rtrTopSale     = $listsaleitemposcortesiaservice->getListSaleItemTopSale3($Companies, $activeCompany);
        $rtrTopSaleHD   = $listsaleitemposcortesiaservice->getListSaleItemTopSaleHD3($Companies, $activeCompany);
        break;      
      default:
        $rtrTotalSaleHD = $listsaleitemposcortesiaservice->getListSaleItemPosTotalSaleHD4($Companies, $activeCompany);
        $rtrTopSale     = $listsaleitemposcortesiaservice->getListSaleItemTopSale4($Companies, $activeCompany);
        $rtrTopSaleHD   = $listsaleitemposcortesiaservice->getListSaleItemTopSaleHD4($Companies, $activeCompany);
        break;
    }
  }
